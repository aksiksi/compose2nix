...
var rootPath = flag.String("root_path", "", "root path to use for any relative paths in the Compose file (e.g., volumes). if unset, the current working directory will be used.")
