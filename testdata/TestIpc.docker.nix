...

{
  ...
  systemd.services."docker-test-test-ipc-container" = {
    ...
    unitConfig.Description = "Container test-test-ipc-container generated by compose2nix.";
    after = [
  ...
  systemd.services."docker-test-test-ipc-host" = {
    ...
    unitConfig.Description = "Container test-test-ipc-host generated by compose2nix.";
    after = [
      "docker-network-test_default.service"
    ];
    requires = [
  ...
  systemd.services."docker-test-test-ipc-private" = {
    ...
    unitConfig.Description = "Container test-test-ipc-private generated by compose2nix.";
    after = [
      "docker-network-test_default.service"
    ];
    requires = [
  ...
  systemd.services."docker-test-test-ipc-service" = {
    ...
    unitConfig.Description = "Container test-test-ipc-service generated by compose2nix.";
    after = [
      "docker-network-test_default.service"
    ];
    requires = [
  ...
  systemd.services."docker-test-test-ipc-shareable" = {
    ...
    unitConfig.Description = "Container test-test-ipc-shareable generated by compose2nix.";
    after = [
      "docker-network-test_default.service"
    ];
    requires = [
