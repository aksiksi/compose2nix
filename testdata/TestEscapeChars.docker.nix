...

{
  ...
  systemd.services."docker-dovecot" = {
    ...
    unitConfig.Description = "Container dovecot generated by compose2nix.";
    after = [
  ...
  systemd.services."docker-network-dovecot_abc" = {
    unitConfig.Description = "Network dovecot_abc generated by compose2nix.";
    path = [ pkgs.docker ];
    serviceConfig = {
      Type = "oneshot";
  ...
  systemd.services."docker-volume-dovecot_def" = {
    unitConfig.Description = "Volume dovecot_def generated by compose2nix.";
    path = [ pkgs.docker ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
