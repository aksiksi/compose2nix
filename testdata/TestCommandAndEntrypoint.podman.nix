...

{
  ...
  systemd.services."podman-test-both" = {
    ...
    unitConfig.Description = "Container test-both generated by compose2nix.";
    after = [
  ...
  systemd.services."podman-test-empty-command-and-entrypoint" = {
    ...
    unitConfig.Description = "Container test-empty-command-and-entrypoint generated by compose2nix.";
    after = [
      "podman-network-test_default.service"
    ];
    requires = [
  ...
  systemd.services."podman-test-null-command-and-entrypoint" = {
    ...
    unitConfig.Description = "Container test-null-command-and-entrypoint generated by compose2nix.";
    after = [
      "podman-network-test_default.service"
    ];
    requires = [
  ...
  systemd.services."podman-test-string" = {
    ...
    unitConfig.Description = "Container test-string generated by compose2nix.";
    after = [
      "podman-network-test_default.service"
    ];
    requires = [
