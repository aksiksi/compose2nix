...

{
  ...
  systemd.services."podman-test-service" = {
    ...
    unitConfig.Description = "Container test-service generated by compose2nix.";
    after = [
  ...
  systemd.services."podman-network-test_my-network" = {
    unitConfig.Description = "Network test_my-network generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
  ...
  systemd.services."podman-volume-test_my-volume" = {
    unitConfig.Description = "Volume test_my-volume generated by compose2nix.";
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
